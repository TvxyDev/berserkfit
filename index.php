...
<html lang="pt-BR">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Poppins:wght@700&family=Inter&display=swap"
      rel="stylesheet"
    />
  </head>
  <body>
      ...
      <section id="inicio">
        <div class="heroi-container">
          <div class="heroi-texto">
            ...
            <a href="login.php" class="botao-heroi fade-in-element"
              >Começar Agora</a
            >
          </div>
      ...
      <div class="footer-container">
        ...
        <div class="footer-column">
          ...
          <div class="social-icons">
            ...
            >
            <a href="#"
              ><img src="assets/twitter.svg" alt="Twitter" /> Twitter</a
            >
          </div>
        </div>
      </div>
