            ...
            <div class="perfil-box">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    <div class="foto-section">
                        ...
                        ?>
                        <img src="<?php echo htmlspecialchars($fotoUsuario); ?>" class="user-photo" id="preview-foto"
                            alt="Foto do Usuário" data-default="<?php echo htmlspecialchars($defaultFoto); ?>">
                        <div class="foto-buttons">
                            ...
                            <button type="button"
                                class="btn-remove <?php echo (empty($user['foto']) || !file_exists($user['foto'])) ? 'hidden' : ''; ?>"
                                id="btn-remover-foto">
                    ...
                    <div class="input-group-row">
                        <div class="input-group">
                            ...
                            <input type="text" id="ddd" name="ddd"
                                value="<?php echo htmlspecialchars($user['ddd'] ?? ''); ?>" maxlength="3"
                                pattern="[0-9]{2,3}">
                        </div>
                        <div class="input-group">
                            <label for="telefone">Telefone</label>
                            <input type="text" id="telefone" name="telefone"
                                value="<?php echo htmlspecialchars($user['telefone'] ?? ''); ?>" maxlength="9"
                                pattern="[0-9]{8,9}">
                        </div>
                    </div>
